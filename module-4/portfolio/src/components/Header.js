...
const Header = () => {
  ...
  const handleScroll = () => {  
    setScrollUp(prevPosition.current > window.scrollY)
  ...
  return (
    <Box
      ...
      transform={scrollUp ? "translateY(0)" : "translateY(-200px)"}
    ...
    >
      <Box color="white" maxWidth="1280px" margin="0 auto">
        ...
        >
          ...
          <nav>
            <HStack spacing={8}>
             <a href="/#projects" key ="projects" onClick={handleClick("projects")}>Projects</a>
